...
const baseDepartures = (stationsAreas) =>
    get(stationUrl(parseInt(stationsAreas[0].fields.uic), stationsAreas[0].fields.intitule_gare))
            ...
            .map(oneRow => {
                ...
                return {
                    ...
                    dataToDisplay: {
                        ...
                        direction: capitalize(oneRow.getElementsByClassName('destination')[0].getElementsByTagName('a')[0] ?
